...
public class TypesonUnmarshallTest {
    ...
    public void testUnmarshallInvalidType(){
        ...
        Throwable throwable = assertThrows(TypesonException.class, () ->
                typeson.unmarshall(data, Shape.class));
        assertEquals("Cannot find a sub-class of io.github.achachraf.typeson.mock.Shape annotated with @ElementType and value='invalid' in classpath", throwable.getMessage());
    }
    ...
    public void testUnmarshallUnannotatedClass(){
        ...
        Throwable throwable = assertThrows(IllegalStateException.class, () ->
                typeson.unmarshall(data, io.github.achachraf.typeson.mock.UnannotatedShape.class));
        assertEquals("Unknown properties: [type, radius] for type: class io.github.achachraf.typeson.mock.UnannotatedShape", throwable.getMessage());
    }
    ...
    public void testUnmarshallUnannotatedSubClass(){
        ...
        Throwable throwable = assertThrows(TypesonException.class, () ->
                typeson.unmarshall(data, Shape.class));
        assertEquals("Cannot find a sub-class of io.github.achachraf.typeson.mock.Shape annotated with @ElementType and value='unannotatedShape' in classpath", throwable.getMessage());
    }
    ...
    public void testUnmarshallNotASubClass(){
        ...
        Throwable throwable = assertThrows(TypesonException.class, () ->
                typeson.unmarshall(data, Shape.class));
        assertEquals("Cannot find a sub-class of io.github.achachraf.typeson.mock.Shape annotated with @ElementType and value='notASubType' in classpath", throwable.getMessage());
    }
    ...
    public void testUnmarshallWithoutTypeField() {
        ...
        Throwable throwable = assertThrows(IllegalStateException.class, () ->
                typeson.unmarshall(data, Shape.class));
        assertEquals("Unknown properties: [radius] for type: class io.github.achachraf.typeson.mock.Shape", throwable.getMessage());
    }
    ...
    public void testUnmarshallDefaultField() {
        ...
        assertEquals("Unknown properties: [type] for type: class io.github.achachraf.typeson.mock.DefaultType", throwable.getMessage());
    }
