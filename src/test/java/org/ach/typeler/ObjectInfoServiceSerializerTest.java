...
public class ObjectInfoServiceSerializerTest {

    private final ObjectInfoServiceSerializer objectInfoServiceSerializer = new ObjectInfoServiceSerializer();

    @Test
    public void testGetSingleObjectInfo() {
        Shape shape = new Circle("Acircle", 10);
        ObjectInfo objectInfo = objectInfoServiceSerializer.getObjectInfo(shape);
    ...
    public void testGetSingleObjectInfoTwoObjects() {
        ...
        ObjectInfo objectInfo = objectInfoServiceSerializer.getObjectInfo(circleAndRectangle);
        assertInstanceOf(SingleObjectInfo.class, objectInfo);
        SingleObjectInfo singleObjectInfo = (SingleObjectInfo) objectInfo;
    ...
    public void testGetSingleObjectInfoComposite(){
        ...
        ObjectInfo objectInfo = objectInfoServiceSerializer.getObjectInfo(firstCompositeMock);
        assertInstanceOf(SingleObjectInfo.class, objectInfo);
        SingleObjectInfo singleObjectInfo = (SingleObjectInfo) objectInfo;
    ...
    public void testGetListObjectInfo(){
        ...
        ObjectInfo objectInfo = objectInfoServiceSerializer.getObjectInfo(shapes);
    ...
    public void testGetSingleObjectInfoWithObjectListInfo(){
        ...
        ObjectInfo objectInfo = objectInfoServiceSerializer.getObjectInfo(figure);
    ...
    public void testGetListObjectInfoWithCompositeListLoopRecursiveSubtypes(){
        ...
        ObjectInfo objectInfo = objectInfoServiceSerializer.getObjectInfo(compositeCollectionList);
    ...
    public void testGetListObjectInfoOfListOfList(){
        ...
        ObjectInfo objectInfo = objectInfoServiceSerializer.getObjectInfo(listOfList);
        assertInstanceOf(ListObjectInfo.class, objectInfo);
        ListObjectInfo listObjectInfo = (ListObjectInfo) objectInfo;
        assertEquals(2, listObjectInfo.getObjectList().size());
