...
import org.ach.typeson.interlay.ConfigProviderMapImpl;
import org.ach.typeson.interlay.DeserializerServiceClassGraph;
...
public class DeserializerServiceClassGraphTest {
    ...
    public void testDeserializeGenericObject(){
        ...
        assertEquals("Field class org.ach.typeson.mock.CustomGeneric is a generic, and it is not supported yet", throwable.getMessage());
    ...
    public void testJsonProperty(){
        ...
        assertEquals("Unknown properties: [many_aliases3] for type: class org.ach.typeson.mock.MockForJsonProperty", throwable.getMessage());
    }
