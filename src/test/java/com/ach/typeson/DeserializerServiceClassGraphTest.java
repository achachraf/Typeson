...
import com.ach.typeson.interlay.ConfigProviderMapImpl;
import com.ach.typeson.interlay.DeserializerServiceClassGraph;
...
public class DeserializerServiceClassGraphTest {
    ...
    public void testDeserializeGenericObject(){
        ...
        assertEquals("Field class com.ach.typeson.mock.CustomGeneric is a generic, and it is not supported yet", throwable.getMessage());
    ...
    public void testJsonProperty(){
        ...
        assertEquals("Unknown properties: [many_aliases3] for type: class com.ach.typeson.mock.MockForJsonProperty", throwable.getMessage());
    }
